...
from haruka import BOT_ID, WHITELISTED, tbot, decorator, bot
from haruka.modules.helper_func.own_errors import NotEnoughRights
from haruka.modules.connections import connection
from haruka.modules.language import get_string, get_strings_dec
from haruka.modules.users import (is_user_admin, user_admin_dec,
